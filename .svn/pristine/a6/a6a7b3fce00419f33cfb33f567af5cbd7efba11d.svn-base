...
public int save(final String sql,final Object[] params){
	...
	public void queryPage(String sql, Page pager) {
		pager.getPageData(sql, this.jdbcTemplate);
	}
	

	public void queryPageWithConditions(String sql, Page pager, String additions) {
		pager.getPageDataWithConditions(sql, this.jdbcTemplate,additions);
	}
}
