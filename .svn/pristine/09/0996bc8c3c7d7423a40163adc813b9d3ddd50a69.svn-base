...
public class MallService {
	...
	*/
	public void insert(Object[] objects) {
		// TODO Auto-generated method stub
		String sql ="insert into jw_gift (communityid,points,name,description,image,creator,inform,createtime,stocks,sortby) values(?,?,?,?,?,?,?,unix_timestamp(),?,?)";
	...
	*/
	...
	public void updateNew(int points,String name,String description,String image,String inform,int id,int stocks,int sortby) {
		// TODO Auto-generated method stub
		String sql = "update  jw_gift set points="+points+",name='"+name+"',description='"+description+"',image='"+image+"',inform='"+inform+"',stocks="+stocks+",sortby="+sortby+" where id="+id;
		dao.update(sql);
	...
	*/
	...
	public void queryForMallListPage(Integer communityid, Page pager) {
		...
		String additions = " order by sortby ";
