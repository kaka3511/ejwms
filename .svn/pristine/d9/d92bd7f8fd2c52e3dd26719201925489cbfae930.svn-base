		...
		<div class="panel-body">
			...
			<form class="form-horizontal" action=''>
				<div class='form-group'>
					<label class='col-xs-4'>商品名称：</label>
					<div class="col-xs-4">
				...
				<div class='form-group'>
					<label class='col-xs-4'>商品图片：</label>
					<div class="col-xs-4">
						
						<input type="hidden" name='image'>
						<img src="images/idcard_default_290_186.png"  class='img img-rounded' style='width:300px;height:150px;'>
				...
				<div class='form-group'>
					<label class='col-xs-4'>库存数量：</label>
					<div class="col-xs-4">
						<input class='form-control' type="text" name='stocks'>
					
					</div>				
				</div>
				<div class='form-group'>
					<label class='col-xs-4'>商品积分：</label>
					<div class="col-xs-4">
				...
				<div class='form-group'>
					<label class='col-xs-4'>排序值：</label>
					<div class="col-xs-4">
						<input class='form-control' type="text" name='sortby'>
					
					</div>				
				</div>
				
				<div class='form-group'>
					<label class='col-xs-4'>商品描述：</label>
					<div class="col-xs-4">
				...
				<div class='form-group'>
					<label class='col-xs-4'>领取说明：</label>
					<div class="col-xs-4">
						<textarea class='form-control' rows="4" name='inform'></textarea>
					
					</div>				
				</div>
				<!-- <div class='form-group'>
					<label class='col-xs-4'>商品状态：</label>
					<div class="col-xs-4">
						<label class="radio-inline">
						  <input type="radio" name="status" value="option1">已上架</input>
						</label>
						<label class="radio-inline">
						  <input type="radio" name="status"  value="option2">已下架</input>
						</label>
