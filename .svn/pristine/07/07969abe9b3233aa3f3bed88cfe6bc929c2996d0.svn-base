		   	...
		   	<div class="panel-heading">
		   					<form class='form-inline' action="">
		   						...
		   						<div class='form-group'>
		   							<label>审核状态：</label>
								    <select class='form-control' id="query_status" value="${query_status}">
		   						 ...
		   						 <div class='form-group'>
		   							<label>用户类型：</label>
								    <select class='form-control' id="query_type" value="${query_type}">
			   							 <option value="-1" selected="selected">全部</option>
		   						...
		   						<div class='form-group'>
									    <label>姓名：</label>
									    <input class='form-control' type='text' id='query_name' value="${query_name}">
		   						</div>
		   						<div style="display: inline-block;">
			   						<div class='form-group'>
										    <label>手机号：</label>
										    <input class='form-control' type='text' id='query_cellphone' value="${query_cellphone}">
			   						</div>
								   <div class='form-group'>
